...
import { NativeBaseProvider, TextArea, useToast, Box, Alert, Input, Divider, Spacer, Heading, HamburgerIcon, FormControl, Pressable, Button, WarningOutlineIcon, Stack, Badge, HStack, VStack, IconButton, Flex, Center, StatusBar, Text, ScrollView } from 'native-base';
...
// import React from 'react';
// import { NativeBaseProvider, Box, Input, FormControl, Button, WarningOutlineIcon, Stack, HStack, IconButton, Center, StatusBar, Text, Icon, ScrollView } from 'native-base';
// import MaterialIcons from 'react-native-vector-icons/FontAwesome5Pro';
...
//               <Input type="1123" defaultValue="12345" placeholder="password" />
